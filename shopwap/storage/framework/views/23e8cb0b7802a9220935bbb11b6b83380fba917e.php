...
<form class="layui-form" action="">
    ...
    <div class="addrcon">
        <input type="hidden" name="address_id" value="<?php echo e($user_address->address_id); ?>">
        <ul>
            <li><em>收货人</em><input type="text" placeholder="请填写真实姓名" name="address_man" value="<?php echo e($user_address->address_man); ?>"></li>
            <li><em>手机号码</em><input type="number" placeholder="请输入手机号" name="address_tel" value="<?php echo e($user_address->address_tel); ?>"></li>
            <li><em>所在区域</em><input id="demo1" type="text"  placeholder="请选择所在区域" name="address_district" value="<?php echo e($user_address->district); ?>"></li>
            <li class="addr-detail"><em>详细地址</em><input type="text" placeholder="20个字以内" class="addr" name="address_detail" value="<?php echo e($user_address->address_detail); ?>"></li>
        </ul>
        <div class="setnormal">
            <span>设为默认地址</span>
            <?php if($user_address->address_default == 1): ?>
...
<script>
    ...
    layui.use('form', function(){
        ...
        $('.m-index-icon').click(function(){
            $.ajax({
                url:"<?php echo e('/addressUpdateDo'); ?>",
