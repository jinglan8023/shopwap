...
<head><meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
    ...
    <link href="<?php echo e(env('STATIC_URL')); ?>css/findpwd.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>layui/css/layui.css">
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>css/modipwd.css">
    ...
    <form class="layui-form" action="">
        <div class="registerCon">
            <ul>
                ...
                <li><p>我们已向<em class="red"><?php echo e($tel); ?></em>发送验证码短信，请查看短信并输入验证码。</p></li>
                <li>
                    <?php echo csrf_field(); ?>
        ...
        <input type="hidden" value="<?php echo e($pwd); ?>" class="pwd">
    </form>
</div>
