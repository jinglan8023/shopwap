...
<head>
    ...
    <link href="<?php echo e(env('STATIC_URL')); ?>css/userprofile.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(env('STATIC_URL')); ?>css/buyrecord.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(env('STATIC_URL')); ?>css/single.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>css/idangerous.swiper.css">
                ...
                <?php $__currentLoopData = $orderInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="buyrecord-con clearfix">
                        ...
                        <div class="order clearfix">
                                <span class="fl">订单号：<i><?php echo e($v->order_no); ?>
...
<script src="<?php echo e(env('STATIC_URL')); ?>js/idangerous.swiper.min.js"></script>
<script>
    // 向上滑动导航条变化
