...
<head>
    ...
    <link href="<?php echo e(env('STATIC_URL')); ?>css/buyrecord.css" rel="stylesheet" type="text/css">
...
<div>
            ...
            <ul class="clearfix">
                ...
                <li class="info">
                    <div class="clearfix">
                        ...
                        <span><?php echo e($addressInfo['address_man']); ?></span>
                        <span class="tel fr"><?php echo e($addressInfo['address_tel']); ?></span>
                    </div>
                    <p class="noaddr">
                        ...
                        <?php echo e($addressInfo['address_detail']); ?>

                    </p>
                </li>
                <a href="/writeAddress"><li><em></em></li></a>
    ...
    <div class="g-pay-lst">
        <ul>
            ...
            <li>
                <input type="hidden" value="<?php echo e($v->goods_id); ?>" class="goods_id">
                <a href="">
                        <span>
                    ...
                    <dl>
                        ...
                        <dd style="color:red;">
                            ￥<em class="price"><?php echo e($v->goods_selfprice); ?></em>
                            X
                            <em class="num"><?php echo e($v->buy_number); ?></em>
                        </dd>
        ...
        <p class="gray9">需支付总金额：<em class="orange"><i>￥</i>1.00</em></p>
    </div>
    ...
    <script>
        ...
        $('#btnPay').click(function(){
            ...
            var address_name=$('.user').next().html();
            var address_tel=$('.tel').html();
            var address_detail=$('.noaddr').html();

            $.ajax({
                url:"<?php echo e('/order'); ?>",
                data:'_token='+_token+'&goods_id='+goods_id+'&address_name='+address_name+'&address_tel='+address_tel+'&address_detail='+address_detail,
                dataType:'json',
                type:'post',
