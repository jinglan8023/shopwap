...
<head>
    ...
    <link href="<?php echo e(env('STATIC_URL')); ?>css/member.css" rel="stylesheet" type="text/css" />
    <script src="<?php echo e(env('STATIC_URL')); ?>js/jquery190_1.js" language="javascript" type="text/javascript"></script>
</head>
<body class="g-acc-bg">
...
<div class="welcome">
    ...
    <a href="<?php echo e('/regi'); ?>" class="orange">注册</a>
</div>
<?php else: ?>
<div class="welcome">
    <i class="set"></i>
    <div class="login-img clearfix">
        <ul>
            <li><img src="<?php echo e(env('IMG_URL')); ?>cover/67f5ad3c1f84ff66a628e9b0e0e6c412.jpg" alt=""></li>
            <li class="name">
                <h3>兰兰<?php echo e(session("user_info['account']")); ?></h3>
                <p>ID：10030053</p>
            </li>
...
<div class="sub_nav marginB person-page-menu">
    ...
    <a href="/member/address"><s class="m_s5"></s>收货地址<i></i></a>
