        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                ...
                <ul id="sortListUl" class="list">
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li sortid="<?php echo e($v['cate_id']); ?>" reletype="<?php echo e($v->cate_id); ?>" linkaddr=''>
                            <span class='items'><?php echo e($v->cate_name); ?></span>
                        </li>
            ...
            <div class="good-list-wrapper">
                ...
                <div class="history"  style="display:block">
                    <dl><img src="<?php echo e(env('STATIC_URL')); ?>/picture/20170302175316313.jpg" alt="" width="60px;" height="60px"></dl>
                    <dd>大衣</dd>
                </div>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <section class="menu-right padding-all j-content">
                            <?php $__currentLoopData = $v['son']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk=>$vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <h6 id="vv"><?php echo e($vv->cate_name); ?></h6>
                                <ul>
                                    <?php $__currentLoopData = $vv['son']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kkk=>$vvv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <dl>
                                                <a href="<?php echo e('/list'); ?>?cate_id=<?php echo e($vvv->cate_id); ?>">
                                                    <img src="<?php echo e(env('STATIC_URL')); ?>/picture/20170302175316313.jpg" alt="" width="60px;" height="60px">
                                                </a>
                                            </dl>
                                            <dd><a href="<?php echo e('/list'); ?>?cate_id=<?php echo e($vvv->cate_id); ?>"><?php echo e($vvv->cate_name); ?></a></dd>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </section>
                ...
                <div class="brand"  style="display:none">
                    <ul>
                        ...
                        <li><a href="<?php echo e($value->brand_id); ?>" class="brand_id"><?php echo e($value->brand_name); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                ...
                <div class="is_new" style="display:none">
                    <ul>
                        <?php $__currentLoopData = $new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keys=>$values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img src="./<?php echo e($values->goods_img); ?>" alt="" width="60px;" height="60px">
                            <li><?php echo e($values->goods_name); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
...
<script src="<?php echo e(env('STATIC_URL')); ?>js/mui.min.js"></script>
<script>
