<div class="footer clearfix">
    <ul>
        ...
        <li class="f_announced"><a href="{{url('/cate')}}" id="allgoods"><i></i>所有分类</a></li>
        <li class="f_single"><a href="{{url('/newknow')}}" ><i></i>最新揭晓</a></li>
...
<script href="{{env('STATIC_URL')}}/js/jquery-1.8.3.min.js"></script>
<script>
//    $(function(){
