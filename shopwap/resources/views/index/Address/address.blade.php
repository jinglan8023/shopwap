...
<div class="addr-wrapp">
    ...
    <div class="addr-list" addrss_id="{{$v->address_id}}">
        <ul>
            <li class="clearfix">
            ...
            <li>
                <p>{{$v->district}}{{$v->address_detail}}</p>
            </li>
            <li class="a-set">
                ...
                <span>设为默认</span>
                <div class="fr">
                    <span><a class="edit" href="/edit?address_id={{$v->address_id}}">编辑</a></span>
...
<script src="{{env('STATIC_URL')}}js/zepto.js" charset="utf-8"></script>
<script src="{{env('STATIC_URL')}}js/sm.js"></script>
<script src="{{env('STATIC_URL')}}js/sm-extend.js"></script>
...
<script src="{{env('STATIC_URL')}}js/jquery-1.8.3.min.js"></script>
<script>
