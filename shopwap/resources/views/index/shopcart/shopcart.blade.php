...
<div>
    ...
    <div class="g-Cart-list">
        @if(!empty($carInfo)&&!empty(session('user_info')))
            <ul id="cartBody">
            @foreach($carInfo as $k=>$v)
            <li>
                <s class="xuan current"   car_id="{{$v->car_id}}" goods_id="{{$v->goods_id}}"></s>
                ...
                <div class="u-Cart-r">
                    ...
                    <div class="num-opt">
                        ...
                        <input class="text_box" name="num" maxlength="6" type="text" value="{{$v->buy_number}}" stock="{{$v->goods_stock}}"  car_id="{{$v->car_id}}" goods_id="{{$v->goods_id}}">
                        <em class="num-add add" car_id="{{$v->car_id}}" goods_id="{{$v->goods_id}}"><i></i></em>
                    </div>
    ...
    <div id="mycartpay" class="g-Total-bt g-car-new" style="">
        <dl>
            ...
            <dd>
                ...
                <a href="{{'/pay'}}" id="all_payment" class="orangeBtn w_account">结算</a>
            </dd>
        </dl>
    </div>
    <div class="hot-recom">
