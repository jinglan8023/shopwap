...
<head>
    ...
    <script src="{{env('STATIC_URL')}}js/jquery190_1.js" language="javascript" type="text/javascript"></script>
</head>
<body class="g-acc-bg">
...
<div class="welcome">
    ...
    <div class="login-img clearfix">
        <ul>
            <li><img src="{{env('IMG_URL')}}cover/67f5ad3c1f84ff66a628e9b0e0e6c412.jpg" alt=""></li>
            <li class="name">
                <h3>兰兰{{session("user_info['account']")}}</h3>
                <p>ID：10030053</p>
            </li>
